...
// 1. Adım: Butonun alabileceği özellikleri tanımlıyoruz
...
export default function Button({ 
  ...
  // 2. Adım: Record<string, string> kullanarak 'any' hatasını engelliyoruz
  ...
  return (
    <button 
      // variants[variant] ve sizes[size] artık güvenli bir şekilde çağrılabilir
